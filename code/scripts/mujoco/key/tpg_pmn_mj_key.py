...
from lib.start_selection.select_start_continuous import sample_starts_tpg_direct_mj_key, tpg_direct_mj_key
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        while eps_tot < num_outer_steps:
            ...
            if i > 1:
                train_starts, sampling_prob_list = tpg_direct_mj_key(trpo=myTRPO,
                                                                     states=old_starts,
                                                                     values=old_val,
                                                                     temp=0.2)
                print(train_starts)
            ...
            old_starts, old_val = sample_starts_tpg_direct_mj_key(trpo=myTRPO)
