...
from lib.mujoco.spatial_gradient import update_reach_prob_map_fine, calc_spatial_reach_prob_grads
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        train_starts = [(43, 43), (43, 44), (44, 43), (44, 44)]
        ...
        while eps_tot < num_outer_steps:
            ...
            if not train_starts:
                ...
                _, result, s_list, a_list, r_list, st_list = myTRPO.train(start_p_list=train_starts,
                                                                          goal_p=myTRPO.grid.goal,
        ...
        np.save(save_path + "rpm_est_" + prefix + "_" + str(seed_val) + "_" + suffix + "_" +
                str(config_dict['barcode']), rpm_est_np)

        rpgm_np = np.array(rp_grad_map_save)
        np.save(save_path + "rpgm_" + prefix + "_" + str(seed_val) + "_" + suffix + "_" +
