...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        while eps_tot < num_outer_steps:
            ...
            starts = sample_nearby(grid=myTRPO.grid, starts=starts, N_new=N_new_val, T_B=T_B_val, M=M_val)
            print("NEW STARTS")
            # print(starts)
            ...
            _, result, s_list, a_list, r_list, st_list = myTRPO.train(start_p_list=starts,
