...
from lib.trpo.trpo_mujoco_point_fine_asym_selfplay import TRPOTrainer
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        old_starts = OldStarts(dist_threshold=0.02, init=tuple(myTRPO.grid.goal), no_threshold=True)
        # print(starts)
