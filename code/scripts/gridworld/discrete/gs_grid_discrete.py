...
from lib.start_selection.select_start import select_start_states_oracle
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        while eps_tot < num_outer_steps:
            ...
            train_starts = select_start_states_oracle(reach_prob_map=rpm)
            print("TRAIN STARTS")
            print(train_starts)
