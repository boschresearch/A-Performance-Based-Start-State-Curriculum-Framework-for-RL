...
from lib.start_selection.select_start_continuous import sg_direct_grid_c
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        while eps_tot < num_outer_steps:
            ...
            print("TRAIN STARTS")
            if i > 1:
                start_candidates, rp_grad_list = sg_direct_grid_c(trpo=myTRPO)
