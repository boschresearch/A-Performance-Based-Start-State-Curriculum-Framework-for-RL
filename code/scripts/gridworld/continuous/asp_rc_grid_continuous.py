...
from lib.trpo.trpo_continuous_asym_selfplay import TRPOTrainer
...
def run_fun(seed_list,
    ...
    for seed_val in seed_list:
        ...
        while eps_tot < num_outer_steps:
            ...
            starts = myTRPO.asym_self_play_start_generation(goal=myTRPO.grid.goal, num_starts=N_new_val)
            print("NEW STARTS")
            # print(starts)
